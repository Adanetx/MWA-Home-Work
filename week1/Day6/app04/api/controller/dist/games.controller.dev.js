...
var gamesGetAll = function gamesGetAll(req, res) {
  var offset = 0;
  var count = 5;
  var max = 12;
...
var gamesGetOne = function gamesGetOne(req, res) {
...
var deletGame = function deletGame(req, res) {
  var gameId = req.params.gameId;
...
var gameUpate = function gameUpate(req, res) {
